...
export default function SilverSuccess({ txId }: Props) {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center px-4 pt-16 pb-10 max-w-[430px] mx-auto">
      ...
      <p className="mt-2 text-[15px] text-[#6B7280] text-center">
        Your Silver purchase is successful.
      </p>
      ...
      <button
        onClick={() => alert("Invoice API not connected yet")}
        className="mt-7 text-[16px] font-medium text-black"
      >
        Download Invoice
      </button>
    </div>
