...
type TransactionDetailsAccordionProps = {
  variant?: "success" | "failed" | "pending";
};

export default function TransactionDetailsAccordion({
  variant = "success",
}: TransactionDetailsAccordionProps) {
            ...
            {isFailed ? (
              ...
              <div className="mt-[20px] border-t border-dashed border-[#E5E7EB] pt-[20px]">
                ...
                <p className="mt-[28px] text-[11px] leading-[16px] text-[#4B5563]">
                  Your gold will be delivered to your account within 24–48
